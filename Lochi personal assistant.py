...
def ask(string):
    ...
    elif string.endswith('hello') or string.endswith('hello lochi'):
        display.insert(END, "\n " + "Hey. How can I help you?")

    elif string.startswith('hey') or string.endswith('hey lochi'):
        display.insert(END, "\n " + "Hello. How can I help you?")

    elif string.startswith('hi') or string.endswith('hi lochi'):
        display.insert(END, "\n " + "Hello. How can I help you?")

    elif string.startswith('lochi'):
        display.insert(END, "\n " + "Lochi is a Personal Assistant Created By Lochan")
...
def about():
    messagebox.showinfo("About", "lochi is a personal assistant created by Lochan")
    webbrowser.open("https://youtube.com/srisailochan")
...
pic = PhotoImage(file="images/lochi assistance.png")
...
display = Text(root, font=types, foreground="#badce0", background="#000000", undo=True, insertbackground="#badce0", wrap="word", cursor="arrow")
...
if 5 <= int(datetime.today().hour) < 12:
    display.insert(END, ">>> Good Morning. I'm lochi(Lochan's Assistant). How can I help you?")
    threading.Thread(target=sounds, args=("sounds/greetings/morning.aac",)).start()
elif 12 <= int(datetime.today().hour) <= 16:
    display.insert(END, ">>> Good Afternoon. I'm lochi (Lochan's Assistant). How can I help you?")
    threading.Thread(target=sounds, args=("sounds/greetings/afternoon.mpeg",)).start()
elif 17 <= int(datetime.today().hour) < 24:
    display.insert(END, ">>> Good Evening. I'm lochi (Lochan's Assistant). How can I help you?")
    threading.Thread(target=sounds, args=("sounds/greetings/evening.mpeg",)).start()
else:
    display.insert(END, ">>> Hey There. I'm lochi (Lochan's Assistant). How can I help you?")
